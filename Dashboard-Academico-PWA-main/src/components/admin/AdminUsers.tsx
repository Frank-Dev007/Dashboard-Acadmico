...
export default function AdminUsers() {
  ...
  const users = [
    ...
    { id: 7, name: 'Admin Principal', email: 'admin@sistema.com', role: 'admin', program: 'Administración', status: 'active', lastLogin: 'Hace 1h' },
  ...
  const stats = [
    ...
    { label: 'Administradores', value: users.filter(u => u.role === 'admin').length, color: 'text-orange-600', bg: 'bg-orange-50' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Administra estudiantes, profesores y administradores</p>
        </div>
        <Dialog>
